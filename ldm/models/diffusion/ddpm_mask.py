...
class DiffusionWrapper_Mask(pl.LightningModule):
    def __init__(self, unet_config):
        super().__init__()
        self.diffusion_model = instantiate_from_config(unet_config)

    def forward(self, x, timesteps=None,  control=None):
        out = self.diffusion_model(x, timesteps, control)
        return out


class DDPM_Mask(pl.LightningModule):
    def __init__(self,
                 unet_config,
        ...
        self.model = DiffusionWrapper_Mask(unet_config) # 调用 UNet 模型
