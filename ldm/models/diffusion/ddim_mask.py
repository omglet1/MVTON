...
class DDIMSampler_Mask(object):
    ...
    def ddim_sampling(self, cond, shape, pose, stem, stem_z, final,
        ...
        #记录数据，并加载一些参数
        intermediates = {'x_inter': [img], 'pred_x0': [img]}  #分别代表每次迭代的结果与预测的x0
    ...
    def p_sample_ddim(self, x, c, t, pose, stem, stem_z, final, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if score_corrector is not None:  #不会调用
    ...
    @torch.no_grad()
    def stochastic_encode(self, x0, t, use_original_steps=False, noise=None):  #加噪声
